...
const index = () => {
    return (
        ...
        >
            <div className='absolute font-outline-4 text-center z-10 top-0 leading-[100px] md:leading-[160px] lg:leading-[180px] text-[#A4C263] text-[90px] lg:text-[200px] md:text-[150px] font-medium mt-[160px] md:mt-[170px] lg:mt-[100px]'>
                TRY<br />AGAIN
            </div>
